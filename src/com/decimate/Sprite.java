...
public class Sprite extends DrawingArea {
    ...
    public Sprite(String img) {
        try {
            ...
            if (image == null) {
                System.out.println(image + " sprite null");
                return;
            }
            ImageIcon sprite = new ImageIcon(image);
            myWidth = sprite.getIconWidth();
    ...
    public final Sprite flipHorizontally() {
    ...
    public final Sprite flipVertically() {
        int[] des = new int[myWidth * maxHeight];
        int pos = 0;
    ...
    public void drawSprite1(int i, int j, int k) {
        ...
        if (l1 > 0 && k1 > 0)
            block_copy_alpha(j1, l1, pixels, myPixels, j2, k1, i2, k, i1);
    }
    ...
    public void drawAdvancedSprite(int i, int j, int alpha) {
        ...
        if (!(l1 <= 0 || k1 <= 0)) {
            drawAlphaGlow(j1, l1, pixels, myPixels, j2, k1, i2, k, i1);
        }
    }
    ...
    public void drawAdvancedSprite(int i, int j) {
        ...
        if (!(l1 <= 0 || k1 <= 0)) {
            drawAlphaSprite(j1, l1, pixels, myPixels, j2, k1, i2, k, i1);
        }
    }
    ...
    public void drawARGBSprite(int xPos, int yPos, int alpha) {
        ...
        if (!(spriteWidth <= 0 || spriteHeight <= 0)) {
            renderARGBPixels(spriteWidth, spriteHeight, myPixels, pixels, i1, alphaValue, j1, j2, i2);
        }
    }
    ...
    public void method346(int i, int j) {
        ...
        if (k1 <= 0 || j1 <= 0) {
            ...
            block_copy(l, k1, j1, i2, i1, l1, myPixels, pixels);
        }
    }
    ...
    public void drawSprite(int i, int k) {
        ...
        if (!(k1 <= 0 || j1 <= 0)) {
            try {
                block_copy_trans(pixels, myPixels, i1, l, k1, j1, l1, i2);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    public void drawSprite3(int x, int y, int opacity) {
        ...
        if (!((width <= 0) || (height <= 0))) {
            setPixels(width, height, pixels, myPixels, alpha, destOffset, srcOffset, destStep, srcStep);
        }
    }
    ...
    public void drawSprite(int i, int k, int color) {
        ...
        if (!(k1 <= 0 || j1 <= 0)) {
            block_copy_trans(pixels, tempArray, i1, l, k1, j1, l1, i2);
        }
    }
    ...
    public void rotate(int dimension, int rotation, int yPosArray[], int zoom, int xPosArray[], int basePosition, int yPosition, int xPosition, int dimension_1, int middle) {
        ...
        try {
            ...
            int l3 = xPosition + yPosition * width;
    ...
    public void draw(Background background, int i, int j) {
        ...
        if (!(j1 <= 0 || i1 <= 0)) {
            block_copy_mask(myPixels, j1, background.imgPixels, i1, pixels, 0, k1, k, l1, l);
        }
    }
    ...
    public void drawSpriteWithOpacity(int xPos, int yPos, int o) {
        ...
        if (xPos + l1 > bottomX) {
            int i3 = (xPos + l1) - bottomX;
            l1 -= i3;
            j2 += i3;
            i2 += i3;
        }
        if (!(l1 <= 0 || k1 <= 0)) {
            block_copy_alpha(j1, l1, pixels, myPixels, j2, k1, i2, opacity, i1);
        }
    }
