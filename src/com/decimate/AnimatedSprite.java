...
public final class AnimatedSprite extends Sprite {
    ...
    public AnimatedSprite(Image image, Component component, int width, int height) {
        ...
        buffer = new BufferedImage(model,
                Raster.createWritableRaster(model.createCompatibleSampleModel(newWidth, newHeight), new DataBufferInt(pixels, pixelCount),
    ...
    @Override
    public void block_copy_mask(int[] src, int scanSize, byte[] dir, int height, int[] dst, int tmp, int dstOff, int dstPtr, int srcOff,
                                int srcPtr) {
