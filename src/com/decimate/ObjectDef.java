                15256, 15259, 15259, 15327, 15326
        };

        hotSpotIDs = new HashSet<>(Arrays.asList(hotSpotIDs_t));
    }
    ...
    private static boolean isOSRSObject(int objectId) {
        return objects_osrs.contains(objectId);

        /*for (int i = 0;
             i < OBJECTS_OSRS.length;
             i++) {
    ...
    public static void writeDefs() throws IOException {
        final BufferedWriter writer = new BufferedWriter(new FileWriter(new File("./obj_def_dump.txt")));
        for (int objId = 0;
             objId < streamIndices.length;
             objId++) {
            final ObjectDef def = forID(objId);
            if (def == null) {
                continue;
            }

            writer.write("if (objectId == " + def.type + ") {");
            writer.newLine();
            writer.write("\tobject.name = \"" + def.name + "\";");
            writer.newLine();
            if (def.objectModelIDs == null) {
                writer.write("\tobject.objectModelIDs = null;");
            } else {
                writer.write("\tobject.objectModelIDs = new int[]{" + Arrays.toString(def.objectModelIDs) + "};");
            }
            writer.newLine();
            writer.write("\tobject.animationID = \"" + def.animationID + "\";");
            writer.newLine();
            writer.write("}");
            writer.newLine();

            System.out.println("finished writing: " + objId + ".");
        }
        writer.close();
    }
    ...
    public static ObjectDef forID(int i) {
        ...
        if (removeObject) {
            for (int i4 = 0;
                 i4 < objectDef.objectModelIDs.length;
                 i4++)
        ...
        if (i == 10805 || i == 10806 || i == 10807) {
            objectDef.actions = new String[5];
            objectDef.name = "Red Nexus";
            objectDef.objectModelIDs = new int[]{62883};
            objectDef.actions[0] = "Siphon";
        }
        if (i == 6080) {
            objectDef.objectModelIDs = new int[]{91118};
            objectDef.name = "Test";
        }
        if (i == 17240) {
            objectDef.objectModelIDs = new int[]{60014};
            objectDef.name = "Test";
        }
        if (i == 17245) {
            objectDef.objectModelIDs = new int[]{60015};
            objectDef.name = "Test";
        }
        if (i == 17272) {
            objectDef.objectModelIDs = new int[]{60016};
            objectDef.name = "Test";
        }
        if (i == 18030) {
            objectDef.objectModelIDs = new int[]{60017};
            objectDef.name = "Test";
        }
        if (i == 20040) {
            objectDef.objectModelIDs = new int[]{60018};
            objectDef.name = "Test";
        }
        if (i == 30808) {
            objectDef.objectModelIDs = new int[]{60019};
            objectDef.name = "Test";
        }
        if (i == 30964) {
            objectDef.objectModelIDs = new int[]{60020};
            objectDef.name = "Test";
        }
        if (i == 31422) {
            objectDef.objectModelIDs = new int[]{60021};
            objectDef.name = "Test";
        }
        if (i == 31423) {
            objectDef.objectModelIDs = new int[]{60022};
            objectDef.name = "Test";
        }
        if (i == 31424) {
            objectDef.objectModelIDs = new int[]{60023};
            objectDef.name = "Test";
        }
        if (i == 44979) {
            objectDef.objectModelIDs = new int[]{60024};
            objectDef.name = "Test";
        }
        if (i == 49138) {
            objectDef.objectModelIDs = new int[]{60025};
            objectDef.name = "Test";
        }
        if (i == 10091) {
        ...
        if (i == 2654) {
            ...
            objectDef.name = "Fountain of the gods";
            objectDef.animationID = -1;
        }
        if (i == 34579 || i == 29030 || i == 29034 || i == 29039) {
            objectDef.animationID = -1;
        }

        if (i == 9030) {
            objectDef.name = "Dragonstone Rock";
        }
        ...
        if (i == 172) {
            ...
            objectDef.modelSizeY = 120;
            objectDef.modelSizeX = 120;
        ...
        if (i == 2966) {
            objectDef.name = "Perk Dust Machine";
            objectDef.hasActions = true;
            objectDef.modelSizeY = 140;
            objectDef.modelSizeX = 140;
            objectDef.modelSizeH = 200;
            objectDef.actions = new String[5];
            objectDef.actions[0] = "Exchange-Items";
            objectDef.actions[1] = "Perk Tree";
        }
        if (i == 2235) {
            objectDef.name = "Tomb 1";
            objectDef.hasActions = true;
            objectDef.actions = new String[5];
            objectDef.actions[0] = "Open Tomb";
        }
        if (i == 3353) {
            objectDef.name = "Tomb 2";
            objectDef.hasActions = true;
            objectDef.actions = new String[5];
            objectDef.actions[0] = "Open Tomb";
        }
        if (i == 6437) {
            objectDef.name = "Tomb 3";
            objectDef.hasActions = true;
            objectDef.actions = new String[5];
            objectDef.actions[0] = "Open Tomb";
        }
        if (i == 6448) {
            objectDef.name = "Corrupted Chest";
            objectDef.hasActions = true;
            objectDef.actions = new String[5];
            objectDef.actions[0] = "Open";
        }
        if (i == 41290) {
            objectDef.name = "Instance Portal";
            objectDef.hasActions = true;
            objectDef.actions = new String[]{"Instance", "Instance Slayer Task", null, null, null};
        }
        if (i == 22721) {
            objectDef.hasActions = true;
            objectDef.actions = new String[5];
        ...
        if (i == 15478) {
            objectDef.name = "Raids Portal";
            objectDef.objectModelIDs = new int[]{15049};
            objectDef.actions = new String[5];
            objectDef.actions[0] = "Start Raid";
        }

        if (i == 20000) {
            objectDef.name = "Decimate Store";
            objectDef.objectModelIDs = new int[]{32672};
            objectDef.actions = new String[5];
            objectDef.actions[0] = "Open Store";
            objectDef.actions[1] = "Open Cosmetic Rare Store";
            objectDef.actions[2] = "Launch Decimate Store";
            objectDef.modelSizeY = 150;
            objectDef.modelSizeX = 150;
            objectDef.modelSizeH = 150;
        }
        if (i == 20001) {
            objectDef.name = "Vote Booth";
            objectDef.objectModelIDs = new int[]{32673};
            objectDef.actions = new String[5];
            objectDef.actions[0] = "Open Vote-Shop";
            objectDef.actions[1] = "Open Voting Sites";
            objectDef.modelSizeY = 150;
            objectDef.modelSizeX = 150;
            objectDef.modelSizeH = 150;
        }
        if (i == 19999) {
            objectDef.name = "Loyalty Grail";
            objectDef.objectModelIDs = new int[]{32674};
            objectDef.actions = new String[5];
            objectDef.actions[0] = "Open Loyalty Shop";
            objectDef.actions[1] = "Open Loyalty Titles";
            objectDef.modelSizeY = 150;
            objectDef.modelSizeX = 150;
            objectDef.modelSizeH = 150;
        }
        ...
        if (i == 7900) {
            objectDef.name = "Diamond Slots";
            objectDef.objectModelIDs = new int[]{40161};
            objectDef.actions = new String[5];
            objectDef.modelSizeY = 100;
            objectDef.modelSizeX = 100;
            objectDef.modelSizeH = 100;
            objectDef.actions[0] = "Start Spinning";
        }
        if (i == 7901) {
            objectDef.name = "Onyx Slots";
            objectDef.objectModelIDs = new int[]{40162};
            objectDef.actions = new String[5];
            objectDef.modelSizeY = 100;
            objectDef.modelSizeX = 100;
            objectDef.modelSizeH = 100;
        ...
        if (i == 7902) {
            objectDef.name = "Group Ironman Vault";
            objectDef.objectModelIDs = new int[]{40163};
            objectDef.actions = new String[5];
            objectDef.modelSizeY = 100;
            objectDef.modelSizeX = 100;
            objectDef.modelSizeH = 100;
            //   objectDef.sizeX = 1;
            //  objectDef.sizeY = 3;
            objectDef.actions[0] = "Open-Vault";
            objectDef.description = "View your ironman groups vault".getBytes();
        }
        if (i == 7903) {
            objectDef.name = "Group Ironman Leaderboard";
            objectDef.objectModelIDs = new int[]{40164};
            objectDef.actions = new String[5];
            objectDef.sizeY = 3;
            objectDef.sizeX = 1;
            objectDef.modelSizeY = 100;
            objectDef.modelSizeX = 100;
            objectDef.modelSizeH = 100;
            objectDef.actions[0] = "View-Leaderboards";
            objectDef.description = "View the current top ironman groups".getBytes();
        }


        if (i == 6420) {
            objectDef.name = "Work Bench";
            objectDef.actions = new String[5];
            objectDef.actions[0] = "Upgrade Items";
        }
        if (i == 26784) {
            objectDef.name = "Golden coin chest";
            objectDef.actions = new String[]{"Use-coin", "Use-all-coins", null, null, null};
        }
        if (i == 26785) {
            objectDef.name = "Silver coin chest";
            objectDef.actions = new String[]{"Use-coin", "Use-all-coins", null, null, null};
        }
        if (i == 26772) {
            objectDef.name = "Red coin chest";
            objectDef.actions = new String[]{"Use-coin", "Use-all-coins", null, null, null};
        }
        if (i == 26771) {
            objectDef.name = "Purple coin chest";
            objectDef.actions = new String[]{"Use-coin", "Use-all-coins", null, null, null};
        }
        if (i == 26280) {
            objectDef.hasActions = true;
        ...
        switch (i) {
            ...
            case 6715:
                ...
                break;
            case 172:
                objectDef.name = "Enhanced Starter Chest";
                objectDef.actions = new String[]{"Open", "Open-All", null, null, null};
                break;
            case 4875:
    ...
    private static void applyTexturing(Model model, int objectId) {
        switch (objectId) {
            case 172:
                model.setTexture(80, new int[]{27677, 28692, 27682, 28737, 27684, 27692, 27686, 19758, 19741, 19751});
                break;
    ...
    public Model renderObject(int objectType, int face, int zA, int zB, int zD, int zC, int k1) {
        ...
        if (adjustToTerrain) {
            ...
            for (int i2 = 0;
                 i2 < model.numberOfVerticeCoordinates;
                 i2++) {
                int vertexX = model.verticesXCoordinate[i2] >> (model.scaledVertices ? 2 : 0);
                int vertexZ = model.verticesZCoordinate[i2] >> (model.scaledVertices ? 2 : 0);
                int l2 = zA + ((zB - zA) * (vertexX + 64)) / 128;
                int i3 = zC + ((zD - zC) * (vertexX + 64)) / 128;
                int j3 = l2 + ((i3 - l2) * (vertexZ + 64)) / 128;
                model.verticesYCoordinate[i2] += j3 - l1 << (model.scaledVertices ? 2 : 0);
            }
            model.normalise();
        }
        return model;
    ...
    private Model getAnimatedModel(int objectType, int animId, int face) {
        ...
        Model model_3 = new Model(modifiedModelColors == null, FrameReader.isFrameNull(animId), face == 0 && animId == -1 && !rescale && !hasOffsets, model);
        if (animId != -1) {
            model_3.createBones();
